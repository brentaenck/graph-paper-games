        ...
        <div className="ui-card">
          ...
          <div className="ui-card-body">
            <div className="ui-alert ui-alert-success">
              <strong>Production Integration:</strong> This demonstrates the full integration of the existing 
              TicTacToeEngine with the dual design system framework. Real game logic + framework components!
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
              ...
              <div className="ui-text-sm">
                <strong>AI Wins:</strong> {gameStats.aiWins} | <strong>Draws:</strong> {gameStats.draws}
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="text-right">
                ...
                {isThinking && (
                  <div className="mt-2">
                    ...
                    <span className="ui-text-sm ui-text-muted">Difficulty: Level {players[1].difficulty}</span>
                  </div>
                )}
              </div>
            </div>
