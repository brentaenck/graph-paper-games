    ...
    <div className="space-y-8">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="handwritten">
              This is the primary handwritten font we can use for game text and UI elements.
              It feels natural and approachable, like someone actually wrote it by hand.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="casual-text">
              This is a more casual, playful font that could work well for informal game elements
              or secondary text that needs to feel fun and relaxed.
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ fontFamily: 'var(--font-sketch)' }}>
              This sketchy font is great for headings and titles, giving that authentic
              hand-drawn appearance that looks like quick sketches in a notebook.
            </p>
          </div>
      ...
      <section className="sketch-border p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <div className="text-center">
            <div className="w-full h-20 rounded" style={{ backgroundColor: 'var(--ink-blue)' }}></div>
            <p className="mt-2 text-sm">Ink Blue</p>
          </div>
          <div className="text-center">
            <div className="w-full h-20 rounded" style={{ backgroundColor: 'var(--pencil-graphite)' }}></div>
            <p className="mt-2 text-sm">Pencil Graphite</p>
          </div>
          <div className="text-center">
            <div className="w-full h-20 rounded" style={{ backgroundColor: 'var(--pencil-eraser)' }}></div>
            <p className="mt-2 text-sm">Eraser Pink/Yellow</p>
          </div>
          <div className="text-center">
            <div className="w-full h-20 rounded" style={{ backgroundColor: 'var(--sketch-danger)' }}></div>
          ...
          <div>
            ...
            <div className="sketch-border p-4 mb-4">
              <p className="handwritten mb-0">
                This container has a hand-drawn border effect using CSS pseudo-elements
                to create multiple overlapping border lines with slight rotations.
              </p>
            </div>
      ...
      <section className="notebook-lines notebook-margin p-6">
        ...
        <div className="space-y-4 handwritten">
          <p>
            ✓ The subtle rotations (-0.5deg to 1.5deg) give elements a natural, 
            hand-placed feeling without being disorienting.
          </p>
          <p>
            ✓ Multiple border layers create authentic hand-drawn line variation.
            Each layer has different opacity and rotation.
          </p>
          <p>
            ✓ Google Fonts (Kalam, Indie Flower, Caveat) provide good hand-written
            aesthetics while maintaining readability.
          </p>
          <p>
            ✓ Color palette stays true to real pen/pencil colors:
            blue ink, graphite gray, eraser pink/yellow.
          </p>
          <p>
            ⚠ Need to test readability on smaller screens and with accessibility tools.
          </p>
          <p>
            💡 Could enhance with subtle CSS animations for "drawing" effects
