...
const GameSymbol: React.FC<GameSymbolProps> = ({ symbol, penStyle, isNew = false, size = 40 }) => {
      ...
      style: {
        animation:
          animationState === 'drawing'
            ? `drawSymbol ${penStyle === 'marker' ? 800 : 500}ms ease-out forwards`
            : undefined,
          ...
          >
            <g>
              ...
              {metadata.winningLine && (
                <WinningLine winningLine={metadata.winningLine} penStyle={penStyle} />
              )}
            </g>
          </svg>
        ...
        <div className="ui-card">
          ...
          <div className="ui-card-body">
            <div className="ui-alert ui-alert-success">
              <strong>Enhanced Production Integration:</strong> Complete dual design system with
              animated symbol drawing, progressive grid animations, and smooth pen style
              transitions!
            </div>
                ...
                {isThinking && (
                  <div className="mt-2">
                    ...
                    <span className="ui-text-sm ui-text-muted">
                      Analyzing with Level {players[1].difficulty} AI
                    </span>
                  </div>
                )}
              </div>
          ...
          footer={
            <div className="flex justify-between items-center">
              ...
              <div className="ui-text-sm ui-text-muted">
                Turn #{gameState.turnNumber} • Enhanced Animations:{' '}
                {newMoves.size > 0 ? 'Active' : 'Ready'}
              </div>
            </div>
          }
        />
