...
const TicTacToeDemo: React.FC = () => {
  ...
  const [penStyle, setPenStyle] = useState<'ballpoint' | 'pencil' | 'marker' | 'fountain'>(
    'ballpoint'
  );
      ...
      <div className="ui-card">
        ...
        <div className="ui-card-body">
          <div className="ui-alert ui-alert-info">
            <strong>True Paper Layout:</strong> The graph paper contains only the game board and
            pieces. All UI elements (scores, turn indicators, controls) are in the modern interface
        ...
        <div className="ui-card-header">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
              ...
              {winner ? (
                <div>
                  {winner === 'draw' ? (
                    ...
                    <div>
                      <p className="ui-text font-bold text-green-600 mb-1">
                        🎉 Player {winner} Wins!
                      </p>
            ...
            <div className="flex items-center gap-3 md:justify-end">
              ...
              <div
                className={`w-12 h-12 rounded-lg flex items-center justify-center font-bold text-2xl order-1 md:order-2
                    ...
                    <g>
                      ...
                      <path
                        ...
                        style={{
                          ...
                          strokeLinecap: 'round',
                          strokeWidth:
                            penStyle === 'marker' ? '3.0' : penStyle === 'pencil' ? '2.3' : '1.8',
                        }}
                      />
                      ...
                      <path
                        ...
                        style={{
                          ...
                          strokeLinecap: 'round',
                          strokeWidth:
                            penStyle === 'marker' ? '3.1' : penStyle === 'pencil' ? '2.6' : '2.1',
                        }}
                      />
                      ...
                      <circle
                        ...
                        style={{
                          opacity: showGrid
                            ? (parseFloat(getPenStyle().opacity) * 0.7).toString()
                            : '0',
                          ...
                          <svg width="40" height="40" viewBox="0 0 40 40">
                            ...
                            <path
                              ...
                              style={{
                                ...
                                strokeDasharray: '34',
                                strokeDashoffset:
                                  animatingCells.has(index) || drawnCells.has(index) ? '0' : '34',
                          ...
                          <svg width="40" height="40" viewBox="0 0 40 40">
                            ...
                            <circle
                              ...
                              style={{
                                ...
                                strokeDasharray: '88',
                                strokeDashoffset:
                                  animatingCells.has(index) || drawnCells.has(index) ? '0' : '88',
        ...
        <div className="border-t border-gray-200 p-4 bg-gray-50">
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex gap-3 items-center">
              <button onClick={resetGame} className="ui-button ui-button-primary ui-button-sm">
                🔄 New Game
              </button>
              <button
                onClick={() => {
            ...
            <div className="flex gap-6 ui-text-sm">
              <span>
                Games: <strong>{gamesPlayed}</strong>
              </span>
              <span>
                Draws: <strong>{draws}</strong>
              </span>
              <span>
                Moves: <strong>{board.filter(cell => cell !== null).length}</strong>
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="ui-card-body">
            <div className="space-y-2 max-h-48 overflow-y-auto">
              {gameHistory.length > 0 ? (
                ...
                <p className="ui-text-sm ui-text-muted italic">No moves yet - start playing!</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="ui-card">
          ...
          <div className="ui-card-body">
            <ul className="ui-text-sm space-y-2">
              <li>
                <strong>Pure Game Focus:</strong> The paper shows only the game state
              </li>
              <li>
                <strong>Authentic Feel:</strong> Like looking down at real graph paper
              </li>
              <li>
                <strong>Clear Hierarchy:</strong> UI vs. game elements are distinct
              </li>
              <li>
                <strong>Professional Interface:</strong> Clean controls around the paper
              </li>
              <li>
                <strong>Scalable Pattern:</strong> Works for any board game size
              </li>
              <li>
                <strong>Mobile Friendly:</strong> UI adapts around fixed paper size
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="ui-card">
        ...
        <div className="ui-card-body">
          <div className="ui-alert ui-alert-info mb-4">
            <strong>Perfect Grid Alignment:</strong> Game elements are now precisely aligned with
            the graph paper grid lines for an authentic "drawn on paper" appearance.
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="ui-text-sm space-y-1 ui-text-muted">
                <li>
                  • Paper background: <code>20px × 20px</code> grid
                </li>
                <li>
                  • Each game cell: <code>60px × 60px</code> (3 grid squares)
                </li>
                <li>
                  • Total game area: <code>180px × 180px</code> (9 grid squares)
                </li>
                <li>
                  • Game position: <code>140px, 140px</code> from paper edge
                </li>
                <li>
                  • Paper size: <code>480px × 480px</code> (24 grid squares)
                </li>
                <li>
                  • Background starts at <code>0, 0</code> (no offset)
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="ui-text-sm space-y-1 ui-text-muted">
                <li>
                  • <strong>Animated SVG symbols:</strong> X and O draw themselves when placed
                </li>
                <li>
                  • <strong>4 different pen styles:</strong> Ballpoint, Pencil, Marker, Fountain
                </li>
                <li>
                  • <strong>Pen-specific textures:</strong> Each style has unique SVG filters
                </li>
                <li>
                  • <strong>Variable stroke width:</strong> Simulates real pen pressure
                </li>
                <li>
                  • <strong>Drawing animation:</strong> Grid and symbols animate progressively
                </li>
                <li>
                  • <strong>Curved grid lines:</strong> Natural hand-drawn paths
                </li>
                <li>
                  • <strong>Authentic imperfections:</strong> Ink dots and pen variations
                </li>
              </ul>
            </div>
          </div>
...
// backgroundOffset: (paperSize - gameArea) / 2`}
      ...
      <div className="ui-card">
        ...
        <div className="ui-card-body">
          <div className="ui-alert ui-alert-info mb-4">
            <strong>Try different pen styles!</strong> Use the pen selector above to see how each
            writing instrument affects the grid lines, X/O symbols, and overall feel of the game.
          </div>

          <div className="ui-alert ui-alert-success mb-4">
            <strong>Marker Improvements:</strong> The marker filter has been refined to maintain
            recognizable X/O shapes while still providing that authentic thick marker feel with
            subtle texture and slight bleeding.
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="ui-text-sm ui-text-muted space-y-1">
                <li>
                  • <strong>Stroke:</strong> Clean blue ink, 2px width
                </li>
                <li>
                  • <strong>Feel:</strong> Smooth, consistent lines
                </li>
                <li>
                  • <strong>Effect:</strong> Slight paper texture filter
                </li>
                <li>
                  • <strong>Best for:</strong> Precise, everyday writing
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="ui-text-sm ui-text-muted space-y-1">
                <li>
                  • <strong>Stroke:</strong> Gray graphite, 2.5px width
                </li>
                <li>
                  • <strong>Feel:</strong> Soft, slightly faded
                </li>
                <li>
                  • <strong>Effect:</strong> Grainy texture with blur
                </li>
                <li>
                  • <strong>Best for:</strong> Sketching, casual games
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            <div>
              ...
              <ul className="ui-text-sm ui-text-muted space-y-1">
                <li>
                  • <strong>Stroke:</strong> Bold blue, 3.5px width
                </li>
                <li>
                  • <strong>Feel:</strong> Thick with subtle texture
                </li>
                <li>
                  • <strong>Effect:</strong> Light blur with displacement
                </li>
                <li>
                  • <strong>Best for:</strong> Bold, clearly visible gameplay
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="ui-text-sm ui-text-muted space-y-1">
                <li>
                  • <strong>Stroke:</strong> Rich navy ink, 2px width
                </li>
                <li>
                  • <strong>Feel:</strong> Elegant with ink flow variation
                </li>
                <li>
                  • <strong>Effect:</strong> Flow displacement filter
                </li>
                <li>
                  • <strong>Best for:</strong> Sophisticated, classic feel
                </li>
              </ul>
            </div>
          </div>
...
M 61 3 Q 59.5 45 60.8 87 Q 61.2 130 59.5 177`}
            ...
            <div>
              ...
              <ul className="ui-text-sm ui-text-muted space-y-1">
                <li>
                  • <strong>Grid lines:</strong> Each line has different timing (0.1s to 0.7s
                  delays)
                </li>
                <li>
                  • <strong>X symbols:</strong> Two strokes draw sequentially (0.6s + 0.3s delay)
                </li>
                <li>
                  • <strong>O symbols:</strong> Circle draws in single motion (0.8s)
                </li>
                <li>
                  • <strong>State management:</strong> Symbols remain visible after drawing
                  completes
                </li>
                <li>
                  • <strong>Positioning:</strong> Each symbol draws in its correct grid cell
                </li>
                <li>
                  • <strong>Winning line:</strong> Highlighted stroke draws in 0.8s
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            <div>
              ...
              <ul className="ui-text-sm ui-text-muted space-y-1">
                <li>
                  • <strong>SVG Turbulence Filter:</strong> Adds paper fiber roughness
                </li>
                <li>
                  • <strong>Variable Stroke Width:</strong> 1.8px to 2.2px simulates pressure
                </li>
                <li>
                  • <strong>Small Ink Dots:</strong> Circles at line intersections
                </li>
                <li>
                  • <strong>Rounded Caps:</strong> <code>strokeLinecap="round"</code> for pen tips
                </li>
              </ul>
            </div>
      ...
      <div className="ui-card">
        ...
        <div className="ui-card-body">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <h4 className="ui-text font-bold mb-3 text-green-600">
                ✅ True Paper + Hand-drawn Grid
              </h4>
              <ul className="ui-text-sm space-y-1 ui-text-muted">
          ...
          <div className="ui-alert ui-alert-success mt-6">
            <strong>Result:</strong> Advanced hand-drawn SVG effects with 4 authentic pen styles,
            animated X/O symbols, curved grid lines, and pen-specific textures create an incredibly
            authentic "sketched directly on graph paper" experience. Watch as the grid draws itself
            line by line, then see X and O symbols animate as you place them - each pen style
            (ballpoint, pencil, marker, fountain) has its own unique character, thickness, and
            texture effects.
          </div>
        </div>
      </div>
