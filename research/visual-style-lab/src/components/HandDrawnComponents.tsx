    ...
    <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="sketch-border p-6 bg-yellow-50">
            <div className="text-center">
              ...
              <p className="handwritten text-sm">"Master Strategist" - Won 25 games in a row</p>
              <div className="mt-4">
      ...
      <section className="sketch-border p-6">
        ...
        <div className="space-y-8">
          ...
          <div className="flex justify-center gap-4">
            <button className="sketch-button">↶ Undo Move</button>
            <button
          ...
          <div className="space-y-3 max-w-md mx-auto">
            ...
            <div className="sketch-border p-3 bg-red-50 border-red-400">
              <div className="flex items-center gap-2">
                ...
                <span className="handwritten text-red-700">
            ...
            <div className="sketch-border p-3 bg-yellow-50 border-yellow-400">
              <div className="flex items-center gap-2">
                ...
                <span className="handwritten text-yellow-700">
                  Your opponent is taking a long time...
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="text-center">
            <div className="relative inline-block">
              <button className="sketch-button">Hover for Help</button>
              <div
              ...
              >
                ...
                <div
                  className="absolute top-full left-1/2 transform -translate-x-1/2 
                                border-l-8 border-r-8 border-t-8 border-transparent border-t-gray-400"
                ></div>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-center">
            <div className="sketch-border p-6 bg-white max-w-md">
              ...
              <div className="flex gap-3 justify-center">
                <button className="sketch-button">Play Again</button>
                <button
                  className="sketch-button"
                  style={{
      ...
      <section className="notebook-lines notebook-margin p-6">
        ...
        <div className="space-y-4 handwritten">
          <p>
            ✓ Form elements maintain the hand-drawn aesthetic while staying functional and
            accessible.
          </p>
          <p>
            ✓ Cards use subtle rotations (-0.5deg to 0.5deg) to feel naturally placed rather than
            perfectly aligned.
          </p>
          <p>
            ✓ Status messages use appropriate colors (green/red/yellow) but maintain the sketch
            border style for consistency.
          </p>
          <p>
            ✓ Interactive elements have hover states that enhance the hand-drawn feeling with slight
            transforms.
          </p>
          <p>
            💡 Could add subtle "pencil stroke" animations when drawing borders or filling progress
            bars.
          </p>
          <p>
            ⚠ Need to ensure all components meet WCAG accessibility standards despite the
            decorative styling.
          </p>
        </div>
      </section>
