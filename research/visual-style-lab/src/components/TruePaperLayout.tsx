      ...
      <div className="ui-card">
        ...
        <div className="ui-card-body">
          <div className="ui-alert ui-alert-info mb-4">
            ...
            All UI elements (turn indicators, scores, timers) live in the modern digital interface
      ...
      <div className="ui-card">
        ...
        <div className="flex justify-center p-8 bg-gray-100">
          <div className="paper-sheet">
            ...
            <div
              className="graph-paper p-8 shadow-lg"
              style={{
                width: '400px',
                height: '400px',
        ...
        <div className="border-t border-gray-200 p-4 bg-gray-50">
          <div className="flex justify-between items-center">
            <div className="flex gap-3">
              <button className="ui-button ui-button-secondary ui-button-sm">↶ Undo Move</button>
              <button className="ui-button ui-button-secondary ui-button-sm">💾 Save Game</button>
            </div>

            <div className="flex gap-3">
              <button className="ui-button ui-button-warning ui-button-sm">⏸ Pause</button>
              <button className="ui-button ui-button-danger ui-button-sm">🏳 Resign</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="ui-card">
          ...
          <div className="ui-card-body">
            <ul className="ui-text-sm space-y-2">
              <li>
                <strong>Authentic Reality:</strong> Matches real pencil-and-paper experience
              </li>
              <li>
                <strong>Clear Mental Model:</strong> Paper = game, Interface = controls
              </li>
              <li>
                <strong>Focus on Game:</strong> Paper draws attention to gameplay
              </li>
              <li>
                <strong>Scalable Design:</strong> Works for any game type/size
              </li>
              <li>
                <strong>Professional Feel:</strong> Clean interface, beautiful game
              </li>
              <li>
                <strong>Mobile Friendly:</strong> UI can adapt around fixed paper size
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="ui-card">
          ...
          <div className="ui-card-body">
            <ul className="ui-text-sm space-y-2">
              <li>
                <strong>Header + Footer:</strong> Controls above/below paper
              </li>
              <li>
                <strong>Side Panels:</strong> UI flanking left/right of paper
              </li>
              <li>
                <strong>Floating Panels:</strong> Overlay UI that can be moved
              </li>
              <li>
                <strong>Tablet Mode:</strong> Portrait layout with stacked UI
              </li>
              <li>
                <strong>Desktop Mode:</strong> Landscape with side panels
              </li>
              <li>
                <strong>Minimal Mode:</strong> Hide all UI, just show paper
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="ui-card-body">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <div
                className="inline-block graph-paper p-4 shadow-md"
                style={{
                  width: '200px',
                  height: '200px',
...
.paper-sheet {
  ...
  box-shadow: realistic-paper;
            ...
            <div>
              ...
              <ul className="ui-text-sm space-y-2">
                <li>
                  • <strong>Mobile:</strong> Stack UI vertically around paper
                </li>
                <li>
                  • <strong>Tablet:</strong> Side-by-side with paper centered
                </li>
                <li>
                  • <strong>Desktop:</strong> Full layout with side panels
                </li>
                <li>
                  • <strong>Paper size:</strong> Scales but maintains aspect ratio
                </li>
                <li>
                  • <strong>UI adapts:</strong> Controls reorganize around paper
                </li>
              </ul>
            </div>
          </div>
