 ...
 */
import type { GameState, GameSettings, Move, Player, ValidationResult, GameOver, Scoreboard, Result, Hint, AIDifficulty } from './types';
/**
...
export interface GameAI {
     ...
     */
    getMove(state: GameState, difficulty: AIDifficulty, playerId: string, timeLimit?: number): Promise<Result<Move>>;
    /**
 ...
 */
export declare function err<E = import('./types').GameError>(error: E): Result<never, E>;
/**
 * Type guard to check if result is successful
 */
export declare function isOk<T, E>(result: Result<T, E>): result is import('./types').Ok<T>;
/**
 * Type guard to check if result is an error
 */
export declare function isErr<T, E>(result: Result<T, E>): result is import('./types').Err<E>;
